...
logger = get_logger("db.experiment_db")
...
class ExperimentDB:
    ...
    def __init__(self, db_path: Optional[str] = None):
        ...
        self._create_tables()
        logger.info("db_connected", db_path=db_path)
    ...
    def add_experiment(
        ...
        **extra_config,
        ...
        logger.info("experiment_added", experiment_id=exp_id, name=name, model=model)
        return exp_id
    ...
    def add_prediction(
        self, experiment_id, image_name, confidence=None, class_name=None, bbox=None
    ):
        """개별 이미지 추론 결과 저장"""
    ...
    def close(self):
        self.conn.close()
        logger.info("db_closed", db_path=self.db_path)
...
if __name__ == "__main__":
    ...
    results_csv = Path(__file__).parent.parent / "training" / "results.csv"
